...
Philosophy graduate turned web developer. Currently in my 2nd year of DAW, passionate about clean code, design patterns, and continuous learning. Actively seeking internships in Barcelona (on-site · hybrid · remote).
...
Aquarium simulation built with JavaFX exploring OOP architecture and design patterns. Includes integration with a QRNG API.

`Java` · `JavaFX` · `Design Patterns` · `OOP` · `QRNG API`
